...
3. **Atomic Forwarding**: The resulting WBNB is pushed to TheFatCat's dedicated staking vault (`FatCatStakingVault` Flap V3 Beacon Proxy), which atomically dispatches $5/36$ to protocol operations (`OPS_SAFE`) and $31/36$ to The Belly.
