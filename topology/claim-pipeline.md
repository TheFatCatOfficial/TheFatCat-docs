...
- Total released quote funds are segregated into per-asset procurement pots proportional to the locked staker weights for each diet asset.
...
- Large batches execute via unified single swaps, eliminating individual sandwich attacks against small holders.
