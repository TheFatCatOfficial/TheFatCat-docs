...
- [Seniority Certificates (Upcoming)]({% link guides/seniority-certificates.md %}): On-chain credential tokens (deployed at genesis, scheduled for a later release phase).
