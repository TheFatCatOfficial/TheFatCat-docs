...
4. **Seniority Certificates (ERC-721)**: Deployed at genesis, exiting mature stakers may burn 100,000 FATCAT to imprint their achieved seniority notch (1–22) into an immutable on-chain SVG certificate (hard-capped at 10,000 tokens, 21-day transfer lock).
