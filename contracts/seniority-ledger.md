...
- **SeniorityCertificate (`SeniorityCertificate.sol`)**: Genesis-deployed ERC-721 credential minted upon maturity exit by burning 100,000 FATCAT (hard-capped at 10,000 tokens, 21-day transfer lock).
