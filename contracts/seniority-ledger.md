...
## 3. Seniority Certificate & Renderer (Post-Launch Phase)

- **SeniorityCertificate (`SeniorityCertificate.sol`)**: ERC-721 credential minted upon maturity exit by burning FATCAT.
