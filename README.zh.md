...
- **时间资历凭证 (Time-Seniority Certificates ERC-721)**：将质押时间与资历沉淀资产化的链上凭证，退役仓位时通过燃烧 FATCAT 铸造。具备对 FATCAT 的持续通缩效益以及 5% 二级版税注入 The Belly 的金库增收机制。
