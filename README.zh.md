...
- **资历证书规划 (Seniority Certificates ERC-721)**：后续版本路线图功能，计划支持退出的仓位销毁 FATCAT 至黑洞地址 `0x...dEaD`，将达到的资历阶梯（1–22）永久印刻为全链上 SVG 凭证。
...
5. **速查与参考 (Reference & FAQ)**：主网创世合约矩阵规范与架构、高频排坑问答、白皮书双语下载专页、法律免责声明与官方生态链接导航。
