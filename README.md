...
- **Time-Seniority Certificates (ERC-721)**: An on-chain credential token assetizing duration, minted via burning FATCAT upon position exit. Delivers dual economic mechanisms of supply deflation for FATCAT and treasury accretion for The Belly through 5% secondary trading royalties.
