...
2. **安全通信与加密要求**：  
   在提交涉及资金安全、逻辑漏洞或越权风险的脆弱性报告时，请使用官方 PGP 密钥对漏洞详情进行加密投递（PGP 密钥指纹将于主网部署时在官方 GitHub 与官网安全板块公布）。
3. **响应与确认时效承诺**：  
   - **24 小时响应**：安全团队承诺在收到漏洞报告后 24 小时内完成接收确认并启动本地环境复现；
   - **48 小时定级**：48 小时内给出初步脆弱性等级评估与应急处置协同方案；
