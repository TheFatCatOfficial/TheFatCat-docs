...
- **[The Belly 水力阻尼机制]({% link zh/protocol/belly.md %})**：一阶指数阻尼物理模型、离散餐次释放比例、半衰期衰减轨迹与 7-窗口安全限额。
...
- **[费用流向拓扑与费率]({% link zh/protocol/fees.md %})**：4% 动态交易税、Flap 平台代扣费用、分账金库分配（5/36 运营 vs. 31/36 大肚皮）与 100 年代币税生命周期。
